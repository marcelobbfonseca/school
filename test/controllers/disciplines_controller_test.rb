...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { name: @discipline.name, user_id: @discipline.user_id } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { name: @discipline.name, user_id: @discipline.user_id } }
